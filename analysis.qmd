...
min(totales$edad)
max(totales$edad)
totales %>% count(estado_civil)
totales %>% count(universidad)
totales %>% count(grupo_carrera)
totales %>% count(ciclo)
mean(totales$promedio, na.rm = T)
sd(totales$promedio, na.rm = T)
min(totales$promedio, na.rm = T)
max(totales$promedio, na.rm = T)
totales %>% count(nse)
totales %>% count(roles)
totales %>% count(vive_con)
totales %>% count(ed_padre)
totales %>% count(ed_madre)
totales %>% count(sit_laboral_padres)
totales %>% count(region)
totales %>% count(tipo_universidad)
```
...
```{r}
totales = totales %>% select(-universidad, -ciclo, -roles, -vive_con, -sit_laboral_padres) %>% drop_na()
```
